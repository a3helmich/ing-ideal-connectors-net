...
///// </summary>
//namespace iDealAdvancedConnector_core31.Tests
//{
//    /// <summary>
...
//        /// <returns>True if it is signed with the given key</returns>
//        private static bool CheckSignature(XmlDocument xmlDocument, RSA key)
//        {
...
//            SignatureDescription signatureDescription = CryptoHelpers.CreateFromName<SignatureDescription>(signedXml.SignedInfo.SignatureMethod);
...
//            //ta = Type.GetType(typeof(RSAPKCS1SHA256SignatureDescription).FullName);
